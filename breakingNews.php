<?php
    ...
    // fetch
    $sql= mysqli_query($conn, "SELECT * FROM breaking_news");    
?>
                    ...
                    <div class="col-12">
                        <div class="page-title-box">
                            <div class="page-title-right">
                                ...
                                <button type="button" class="btn btn-info waves-effect waves-light" data-toggle="modal" data-target="#con-close-modal"><i class="mdi mdi-file-plus mr-1"></i>Breaking news</button>
                            </div>
                ...
                <div id="con-close-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title text-capitalize">upload breaking news</h4>
                            ...
                            <div class="modal-body p-4">
                                ...
                                <form action="uploadBreakingNews.php" method="POST" id="uploadImageForm">
                                <div class="form-row">
                      <div class="form-group col-md-6">
                        <label for="inputEmail4">Reporter</label>
                        <input type="text" name="reporter" class="form-control" id="inputEmail4" placeholder="Reporter" style="font-size: 12px; height: 45px;">
                      </div>
                      <div class="form-group col-md-6">
                    ...
                    <div class="form-group">
                            ...
                            <div class="input-group col-xs-12">
                              <input type="text" name="video_url" class="form-control file-upload-info" placeholder="Upload video"  style="font-size: 12px; height: 45px;">
                    ...
                    <button type="submit" name="submit" class="btn btn-info float-right">Publish</button>
                     <button type="button" class="btn btn-light waves-effect float-right mr-1" data-dismiss="modal">Close</button>
                                ...
                                <div class="card">
                                    <img class="card-img-top img-fluid" style"height: 180px;" src="<?php echo $cover;?>" alt="Card image cap">
                                        ...
                                        <?php
                                            if($status == 1){
                                                ?>
                                                <a href="unpublishBreakingNews.php?id=<?php echo $id;?>"><span class="badge badge-pill badge-primary card-title" style="margin-top: -10px;">Published</span></a>
                                                <?php
                                            }else{
                                                ?>
                                                <a href="publishBreakingNews.php?id=<?php echo $id;?>"><span class="badge badge-pill badge-warning card-title" style="margin-top: -10px;">Unpublished</span></a>
                                                <?php
                                            }
                                        ?>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-10">
                                                <span>view</span>
                                                <span><a href="viewBreakingNews.php?id=<?php echo $row['id']?>"><i class="mdi mdi-eye-check-outline"></i></a></span>
                                            </div>
                                            <div class="col-md-2">
                                                ...
                                                <div class="dropdown-menu">
                                                    <!-- item-->
                                                    <a href="edit_breakingNews.php?id=<?php echo $row['id']?>" class="dropdown-item">
