<?php
    ...
    // fetch
    $sql= mysqli_query($conn, "SELECT * FROM drama");    
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <body>
                    ...
                    <div class="col-12">
                        <div class="page-title-box">
                            <div class="page-title-right">
                                ...
                                <button type="button" class="btn btn-info waves-effect waves-light" data-toggle="modal" data-target="#con-close-modal"><i class="mdi mdi-file-plus mr-1"></i>Drama</button>
                            </div>
                            <h4 class="page-title">Drama</h4>
                        </div>
                    </div>
                </div>  
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title text-capitalize">upload drama</h4>
                            ...
                            <div class="modal-body p-4">
                                ...
                                <form action="uploadDrama.php" method="post" enctype="multipart/form-data" id="uploadImageForm">
                                    <div class="form-row">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-img-overlay text-right">
                                        <?php
                                            if($status == 1){
                                                ?>
                                                <a href="unpublishDrama.php?id=<?php echo $id;?>"><span class="badge badge-pill badge-primary card-title" style="margin-top: -10px;">Published</span></a>
                                                <?php
                                            }else{
                                                ?>
                                                <a href="publishDrama.php?id=<?php echo $id;?>"><span class="badge badge-pill badge-warning card-title" style="margin-top: -10px;">Unpublished</span></a>
                                                <?php
                                            }
                                        ?>
                                    </div>
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                           <div class="col-md-10">
                                                <span>view</span>
                                                <span><a href="viewDrama.php?id=<?php echo $row['id']?>"><i class="mdi mdi-eye-check-outline"></i></a></span>
                                            </div>
                                            <div class="col-md-2">
                                                ...
                                                <div class="dropdown-menu">
                                                    <!-- item-->
                                                    <a href="edit_drama.php?id=<?php echo $row['id']?>" class="dropdown-item">
                                                    ...
                                                    <!-- item-->
                                                    <a href="javascript:void(0);" class="dropdown-item delete_drama" data-id="<?php echo $row['id']?>">
        ...
        <script>
            $('.delete_drama').click(function(){
                ...
                .then((willDelete) => {
                    if(willDelete){
                        $.ajax({url:"delete_drama.php?id="+d_id,chache:false,success:function(responses){
                            swal({
                                title: "Done",
