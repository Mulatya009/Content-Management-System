<?php
    ...
    // fetch
    $sql= mysqli_query($conn, "SELECT * FROM latest_movies");    
?>
...
<head>
    ...
    <body>
                    ...
                    <div class="col-12">
                        <div class="page-title-box">
                            <div class="page-title-right">
                                ...
                                <button type="button" class="btn btn-info waves-effect waves-light" data-toggle="modal" data-target="#con-close-modal"><i class="mdi mdi-file-plus mr-1"></i>Latest movies</button>
                            </div>
                            <h4 class="page-title">Latest movies</h4>
                        </div>
                    </div>
                </div>  
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title text-capitalize">upload latest movies</h4>
                            ...
                            <div class="modal-body p-4">
                                ...
                                <div id="news_messages">
                                 ...
                                 <form action="uploadLatestMovie.php" method="post" enctype="multipart/form-data" id="uploadImageForm">
                                    <div class="form-row">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-img-overlay text-right">
                                        <?php
                                            if($status == 1){
                                                ?>
                                                <a href="unpublishLatestMovies.php?id=<?php echo $id;?>"><span class="badge badge-pill badge-primary card-title" style="margin-top: -10px;">Published</span></a>
                                                <?php
                                            }else{
                                                ?>
                                                <a href="publishLatestMovies.php?id=<?php echo $id;?>"><span class="badge badge-pill badge-warning card-title" style="margin-top: -10px;">Unpublished</span></a>
                                                <?php
                                            }
                                        ?>
                                    </div>
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-10">
                                                <span>view</span>
                                                <span><a href="viewLatestMovies.php?id=<?php echo $row['id']?>"><i class="mdi mdi-eye-check-outline"></i></a></span>
                                            </div>
                                            <div class="col-md-2">
                                                ...
                                                <div class="dropdown-menu">
                                                    <!-- item-->
                                                    <a href="edit_latestMovies.php?id=<?php echo $row['id']?>" class="dropdown-item">
                                                    ...
                                                    <!-- item-->
                                                    <a href="javascript:void(0);" class="dropdown-item delete_latestMovie" data-id="<?php echo $row['id']?>">
        ...
        <script>
            $('.delete_latestMovie').click(function(){
                var id = $(this).attr('data-id');
                // alert;
                swal({
                    title: "Do you want to delete this latest movie?",
                ...
                .then((willDelete) => {
                    if(willDelete){
                        $.ajax({url:"delete_latestMovies.php?id="+id,chache:false,success:function(responses){
                            swal({
                                title: "Done",
