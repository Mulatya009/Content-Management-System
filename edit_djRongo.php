<?php
    ...
    // fetch
    $sql= mysqli_query($conn, "SELECT * FROM dj_rongo WHERE id = '$id'");  
    ...
    <body class="pt-5">
        ...
        <br>
            ...
            <div class=" py-3 pl-5">
                ...
                <form class="forms-sample" action="edit_djRongo_ajax.php?id=<?php echo $id; ?>" method="post" enctype="multipart/form-data" id="uploadImageForm">
