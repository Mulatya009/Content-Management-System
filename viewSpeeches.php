            ...
            <div class="row m-4">
                ...
                <div class="">
                    <div class="content-wrapper pt-3">
                        ...
                        <small> <?php echo $row['datereg']; ?></small>
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <div class="mt-2">
                                <img style = "width: 650px; height: 400px;" class="img-fluid" src="<?php echo $row['banner_image']; ?>" alt="">
                            </div>
                            <hr>
                            <div class="mt-2">
                                ...
                                ?>
                                    ...
                                    <div class="row">
                                        <div class="mt-2 col-6">
                                            <img style = "width: 180px; height: 100px;" class="img-fluid rounded" src="<?php echo $row['square_image']; ?>" alt="">
                                        </div>
