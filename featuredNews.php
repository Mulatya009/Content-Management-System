<?php
    ...
    // fetch
    $sql= mysqli_query($conn, "SELECT * FROM featured_news");    
?>
    ...
    <body>
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-12">
                        <div class="page-title-box">
                            <div class="page-title-right">
                                ...
                                <button type="button" class="btn btn-info waves-effect waves-light" data-toggle="modal" data-target="#con-close-modal"><i class="mdi mdi-file-plus mr-1"></i>Featured news</button>
                            </div>
                            <h4 class="page-title">Featured news</h4>
                        </div>
                    </div>
                </div>  
                ...
                <div id="con-close-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title text-capitalize">upload featured news</h4>
                            ...
                            <div class="modal-body p-4">
                                ...
                                <form action="uploadFeaturedNews.php" method="POST" id="uploadImageForm">
                                <div class="form-row">
                    ...
                    <button type="submit" name="submit" class="btn btn-info float-right">Publish</button>
                     <button type="button" class="btn btn-light waves-effect float-right mr-2" data-dismiss="modal">Close</button>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-img-overlay text-right">
                                        <?php
                                            if($status == 1){
                                                ?>
                                                <a href="unpublishFeaturedNews.php?id=<?php echo $id;?>"><span class="badge badge-pill badge-primary card-title" style="margin-top: -10px;">Published</span></a>
                                                <?php
                                            }else{
                                                ?>
                                                <a href="publishFeaturedNews.php?id=<?php echo $id;?>"><span class="badge badge-pill badge-warning card-title" style="margin-top: -10px;">Unpublished</span></a>
                                                <?php
                                            }
                                        ?>
                                    </div>
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-10">
                                                <span>view</span>
                                                <span><a href="viewFeaturedNews.php?id=<?php echo $row['id']?>"><i class="mdi mdi-eye-check-outline"></i></a></span>
                                            </div>
                                            <div class="col-md-2">
                                                ...
                                                <div class="dropdown-menu">
                                                    <!-- item-->
                                                    <a href="edit_featuredNews.php?id=<?php echo $row['id']?>" class="dropdown-item">
        ...
        <script>
            $('.delete_user').click(function(){
                ...
                // alert;
                swal({
                    title: "Do you want to delete this featured news?",
                ...
                .then((willDelete) => {
                    if(willDelete){
                        $.ajax({url:"delete_featuredNews.php?id="+d_id,chache:false,success:function(responses){
                            swal({
                                title: "Done",
                                text: "The featured news has been deleted!",
                                icon: "success",
                                button: "Back",
                            });
                        ...
                        swal({
                                title: "Cancelled",
                                text: "Your featured news is safe!",
                                icon: "info",
                                button: "Exit",
                            });
                    }
