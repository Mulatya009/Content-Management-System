<?php
    ...
    // fetch
    $sql= mysqli_query($conn, "SELECT * FROM latest_music");    
?>
...
<head>
    ...
    <body>
                    ...
                    <div class="col-12">
                        <div class="page-title-box">
                            <div class="page-title-right">
                                ...
                                <button type="button" class="btn btn-info waves-effect waves-light" data-toggle="modal" data-target="#con-close-modal"><i class="mdi mdi-file-plus mr-1"></i>Latest music</button>
                            </div>
                            <h4 class="page-title">Latest music</h4>
                        </div>
                    </div>
                </div>  
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title text-capitalize">upload latest music</h4>
                            ...
                            <div class="modal-body p-4">
                                ...
                                <form action="uploadLatestMusic.php" method="post" enctype="multipart/form-data" id="uploadImageForm">
                                    <div class="form-row">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-img-overlay text-right">
                                        <?php
                                            if($status == 1){
                                                ?>
                                                <a href="unpublishLatestMusic.php?id=<?php echo $id;?>"><span class="badge badge-pill badge-primary card-title" style="margin-top: -10px;">Published</span></a>
                                                <?php
                                            }else{
                                                ?>
                                                <a href="publishLatestMusic.php?id=<?php echo $id;?>"><span class="badge badge-pill badge-warning card-title" style="margin-top: -10px;">Unpublished</span></a>
                                                <?php
                                            }
                                        ?>
                                    </div>
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-10">
                                                <span>view</span>
                                                <span><a href="viewLatestMusic.php?id=<?php echo $row['id']?>"><i class="mdi mdi-eye-check-outline"></i></a></span>
                                            </div>
                                            <div class="col-md-2">
                                                ...
                                                <div class="dropdown-menu">
                                                    <!-- item-->
                                                    <a href="edit_latestMusic.php?id=<?php echo $row['id']?>" class="dropdown-item">
                                                    ...
                                                    <!-- item-->
                                                    <a href="javascript:void(0);" class="dropdown-item delete_latestMusic" data-id="<?php echo $row['id']?>">
        ...
        <script>
            $('.delete_latestMusic').click(function(){
                var lm_id = $(this).attr('data-id');
                // alert;
                swal({
                    title: "Do you want to delete this latest music?",
                    text: "Once deleted you will not be able to retrieve it!",
                    icon: "warning",
                    buttons: true,
                    dangerMode: true,
                })
                .then((willDelete) => {
                    if(willDelete){
                        $.ajax({url:"delete_latestMusic.php?id="+lm_id,chache:false,success:function(responses){
                            swal({
                                title: "Done",
                                text: "The latest music has been deleted!",
                                icon: "success",
                                button: "Back",
                            });
                        ...
                        swal({
                            title: "Cancelled",
                            text: "Your latest music is safe!",
                            icon: "info",
                            button: "Exit",
                        });
                    }
                ...
                // alert(d_id);
                  ...
                  .then((willDelete) => {
                    if (willDelete) {
                        ...
                        $.ajax({url:"delete_breakingNews.php?id="+d_id,cache:false,success:function(responses){
                            //$("#delete_messages").html(responses);
                            swal({
                              title: "Done!",
                              text: "You deleted the breaking news!",
                              icon: "success",
                              button: "Back",
                            });
                            setTimeout(location.reload.bind(location), 3000);
                      ...
                      swal({
                          title: "Cancelled!",
                          text: "Your breaking news is safe!",
                          icon: "info",
                          button: "Exit",
                        });
                    }
