<?php
    ...
    // fetch
    $sql= mysqli_query($conn, "SELECT * FROM speeches");    
?>
...
<head>
    ...
    <body>
                    ...
                    <div class="col-12">
                        <div class="page-title-box">
                            <div class="page-title-right">
                                ...
                                <button type="button" class="btn btn-info waves-effect waves-light" data-toggle="modal" data-target="#con-close-modal"><i class="mdi mdi-file-plus mr-1"></i>Speech</button>
                            </div>
                            <h4 class="page-title">Speaches</h4>
                        </div>
                    </div>
                </div>  
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title text-capitalize">upload speech</h4>
                            ...
                            <div class="modal-body p-4">
                                ...
                                <form action="uploadSpeech.php" method="post" enctype="multipart/form-data" id="uploadImageForm">
                                    <div class="form-row">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-img-overlay text-right">
                                        <?php
                                            if($status == 1){
                                                ?>
                                                <a href="unpublishSpeeches.php?id=<?php echo $id;?>"><span class="badge badge-pill badge-primary card-title" style="margin-top: -10px;">Published</span></a>
                                                <?php
                                            }else{
                                                ?>
                                                <a href="publishSpeeches.php?id=<?php echo $id;?>"><span class="badge badge-pill badge-warning card-title" style="margin-top: -10px;">Unpublished</span></a>
                                                <?php
                                            }
                                        ?>
                                    </div>
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-10">
                                                <span>view</span>
                                                <span><a href="viewSpeeches.php?id=<?php echo $row['id']?>"><i class="mdi mdi-eye-check-outline"></i></a></span>
                                            </div>
                                            <div class="col-md-2">
                                                ...
                                                <div class="dropdown-menu">
                                                    <!-- item-->
                                                    <a href="edit_speeches.php?id=<?php echo $row['id']?>" class="dropdown-item">
                                                    ...
                                                    <!-- item-->
                                                    <a href="javascript:void(0);" class="dropdown-item delete_speeches" data-id="<?php echo $row['id']?>">
        ...
        <!-- delete speaches news-->
        <script>
            $('.delete_speeches').click(function(){
                var d_id = $(this).attr('data-id');
                // alert;
                swal({
                    title: "Do you want to delete this speech?",
                ...
                .then((willDelete) => {
                    if(willDelete){
                        $.ajax({url:"delete_speaches.php?id="+d_id,chache:false,success:function(responses){
                            swal({
                                title: "Done",
                                text: "The speech has been deleted!",
                                icon: "success",
                                button: "Back",
                            });
