<?php
    ...
    // fetch
    $sql= mysqli_query($conn, "SELECT * FROM speeches WHERE id = '$id'");  
    ...
    <body class="pt-5">
        ...
        <br>
            ...
            <div class=" py-3 pl-5">
                ...
                <form class="forms-sample" action="edit_speeches_ajax.php?id=<?php echo $id; ?>" method="post" enctype="multipart/form-data" id="uploadImageForm">
        ...
        <script type="text/javascript">
    	    ...
    	    defaultPreviewContent: '<img src="<?php echo $row['square_image']; ?>" alt="Your Avatar" style="width:165px; border-radius: 5px;"><h6 class="text-muted">Click to select square size</h6>',
    	    ...
    	    msgErrorClass: 'alert alert-block alert-danger',
    	    defaultPreviewContent: '<img src="<?php echo $row['banner_image']; ?>" alt="Your Avatar" style="width:391px; height: 165px; border-radius: 5px;"><h6 class="text-muted">Click to select banner size</h6>',
    	    layoutTemplates: {main2: '{preview} {remove} {browse}'},
    	    allowedFileExtensions: ["jpg", "jpeg", "png", "svg", "gif", "PNG"]
    		});
